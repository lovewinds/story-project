...
public:
  ...
  void appendObjectDesc(std::shared_ptr<Resource::ProjectObject> obj_desc) {
  ...
  const std::vector<std::shared_ptr<Resource::ProjectObject>>& obj_array;
...
protected:
  ...
  std::vector<std::shared_ptr<Resource::ProjectObject>> _obj_array;
};
